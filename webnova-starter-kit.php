...
// Demo Installer
require_once WEBNOVA_STARTER_KIT_PATH . 'admin/demo-installer/class-installer-admin.php';
...
add_action('plugins_loaded', function (): void {
    ...
    $registry = new WebNova_Starter_Kit_Template_Registry(WEBNOVA_STARTER_KIT_PATH . 'templates');
    ...
    // Path relativo a la instalación de WordPress o constante si existiera. Asumiremos que el manifiesto base está en demo/manifests/institutional.json
    $demo_manifest_path = ABSPATH . '../demo/manifests/institutional.json';
    if (!file_exists($demo_manifest_path)) {
        // Fallback local por si estamos dentro del plugin
        $demo_manifest_path = WEBNOVA_STARTER_KIT_PATH . 'templates/sitio-institucional/manifest.json';
    }
    ...
    $demo_admin = new WebNova_Demo_Installer_Admin_Page();
    $demo_admin->hooks();
});
